...
[Download `rosaverplace.rbxl`](../rosaver%20place.rbxl) [Releases Tab `Releases`](releases/latest), open it in Studio, and select **File → Publish to Roblox As…**. Choose your own group and create a new experience.
